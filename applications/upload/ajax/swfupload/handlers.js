...
function uploadSuccess(file, serverData) {
  ...
  try {
	  ...
	  if(json_data_object.status == "done") {
		  ...
		  var elSel = document.getElementById('temporary_files_to_assign_thumbnail');

		  var elOptNew = document.createElement('option');

		  elOptNew.text = json_data_object.file.name;

		  elOptNew.value = json_data_object.file.filename;

		  var elSel1 = document.getElementById('temporary_files_to_assign_gallery_preview');

		  var elOptNew1 = document.createElement('option');

		  elOptNew1.text = json_data_object.file.name;

		  elOptNew1.value = json_data_object.file.filename;

		  var elSel2 = document.getElementById('temporary_files_to_assign_source');

		  var elOptNew2 = document.createElement('option');

		  elOptNew2.text = json_data_object.file.name;

		  elOptNew2.value = json_data_object.file.filename;
		  ...
		  try {
		    ...
		    elSel1.add(elOptNew1, null); // standards compliant; doesn't work in IE

		    elSel2.add(elOptNew2, null); // standards compliant; doesn't work in IE
