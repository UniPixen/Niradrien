<?php 
	_setView(__FILE__);
	_setTitle($langArray['page_not_found']);

	// ON CHARGE LES ACHATS
	...
	$topSellProducts = $ordersClass->getTopSellers(0, 6, " AND paid_datetime > '$startDate 23:59:59' AND paid_datetime < '$endDate 23:59:59' ");
	...
	$topMonthlyProducts = $ordersClass->getTopSellers(0, 6, " AND paid_datetime > '$startMonthlyDate 00:00:00' AND paid_datetime < '$endMonthlyDate 23:59:59' ");
